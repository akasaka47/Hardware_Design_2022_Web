<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>指纹数据-训练集</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图区域 -->
...
export default {
  ...
  methods: {
    ...
    async deleteRSS(order) {
      if (!this.Admin) return this.$message.error("无操作权限");
    ...
    dataSelectionChange(val) {
      ...
      window.sessionStorage.setItem("selectAll", false);
      window.sessionStorage.setItem("selectType", "train");
      this.showOnMap = true;
